...
import art from "@/public/backstory/nightmare_fuel/art.jpg";
import gatherer from "@/public/backstory/nightmare_fuel/gatherer.jpg";
import third from "@/public/backstory/nightmare_fuel/third.png";
import stone from "@/public/backstory/nightmare_fuel/stone.png";
        ...
        <div className="firstStoryPage__box">
          <div className="showdown">
            ...
            <div className="showdown__image">
              <Image src={art} quality={100} alt="" />
            </div>
          </div>
          <div className="gatherer">
            <div className="gatherer__grid">
              ...
              <div className="gatherer__content">
                ...
                <div className="gatherer__box">
                  ...
                  <div className={"_littleText"}>
                    ...
                    <div className="gatherer__text">
                      *bzzzzzt - snooze - bzzzzt - snooze.*{" "}
                    </div>{" "}
                    {Array.from({ length: 5 }).map((_, i) => {
                      return <div key={i}>.</div>;
                    })}{" "}
                    Being late for work or school became something normal. The
                    advanced society of Ayyon was able to reorganize processes
                    and continue to exist with this loss. More and more often
          ...
          <div className="gatherer">
            <div className="third__grid">
              ...
              <div className="third__image">
                <Image src={third} quality={100} alt="" />
              </div>
            </div>
          </div>
          <div className="forth">
            <Image src={stone} alt="stone" quality={100} />
          ...
          <div className="fifth">
            <div className="fifth__box">
              <div className={"_littleText"}>
                ...
                , who came out of sleep and saw what became the fuel for these
                nightmares.{" "}
                <div className="fifth__box__text">
